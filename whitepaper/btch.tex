...
extracted directly from the internal Bitcoin LevelDB database with the \cite{utxodump} tool. It took approximately 22 minutes to dump all 65 million UTXOs at this height.
