...
\textbf{7002416} transparent addresses are above the dust level of 0.01BTC, and these addresses and values will be transported to the BTCH chain.

Note that UTXOs of any size are taken into account, but the final sum of all UTXOs in one taddr must be at least 0.01BTC
to be part of the airdrop. This level was also used by the Bitcore project (BTX).
